...
const Home = () => {
  ...
  return (
    ...
    <>
      <SEO
        title="Home"
        description="Welcome to COEP ZEST 2026, the annual sports festival of COEP Technological University. Witness the roar of victory!"
      />
...
`}
  ...
  ">
              ...
              {/* IMAGE */}
              <div className="col-span-6 w-full h-full  md:col-span-1 flex items-center justify-center relative">
                <h1 style={{
                  position: 'absolute',
                  width: '1px',
                  height: '1px',
                  ...
                  COEP ZEST 2026 – Official Sports Fest of COEP Technological University
                </h1>
                <img
